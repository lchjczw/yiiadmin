...
class DatabaseForm extends Model
{
    ...
    {
        Yii::$app->controller->module->setEnv('DB_USERNAME', $this->username);
        Yii::$app->controller->module->setEnv('DB_PASSWORD', $this->password);
        Yii::$app->controller->module->setEnv('DB_TABLE_PREFIX', $this->prefix);
        Yii::$app->controller->module->setEnv('DB_DSN', "mysql:host=$this->hostname;dbname=$this->database;port=$this->port");
